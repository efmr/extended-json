...
module.exports = {
  ...
  deflate: {
    ...
    '$timestamp': function(val) {
      return bson.Timestamp(Number(val.$timestamp.$t),
        Number(val.$timestamp.$i));
    },
...
module.exports.isSpecial = function isSpecial(value) {
  return module.exports.special.types.indexOf(module.exports.type(value)) > -
    1;
};
